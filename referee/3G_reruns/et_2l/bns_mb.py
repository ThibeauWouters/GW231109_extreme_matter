...
outdir = "outdir"
label = "ET2L_gw231109_injection_alignedspin"
...
# ET 2L design: ET_EMR (Meuse-Rhine, Belgium/Netherlands) + ET_Sar (Sardinia), both 15 km — ET_CoBA_15km PSD
ifos = bilby.gw.detector.InterferometerList(["ET_EMR", "ET_Sar"])
